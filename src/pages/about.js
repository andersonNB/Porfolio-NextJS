            ...
            <main className="flex w-full flex-col items-center justify-center dark:text-light">
                <Layout className="pt-16">
                    ...
                    <div className="grid w-full grid-cols-8 gap-16 sm:gap-8 ">
                        ...
                        <div className="bg-cyan-600 col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3 ">
                            <div className="bg-emerald-600 flex flex-col items-end justify-center xl:items-center">
                                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl "> <AnimatedNumbers value={ 50 } />+</span>
                                <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm ">Satisfed Clients</h2>
                            </div>
                            <div className="bg-emerald-600 flex flex-col items-end justify-center xl:items-center">
