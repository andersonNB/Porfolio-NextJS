        ...
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col" >
            <div className="w-1/2 md:w-full">
              {/* Optimizando carga de imagen en la página principal
                tendrá prioridad de renderizado por encima de otros componentes
               */}
            ...
            <div className="w-1/2 flex flex-col items-center self-center bg-rose-400 lg:w-full lg:text-center ">
              {/* ! -> es en tailwind es la forma de decir que sea importante el estilo */ }
