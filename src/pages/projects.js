    ...
    return (
        ...
        ">
            ...
            <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6">
                ...
                <p className="my-2 font-medium text-dark text-justify dark:text-light sm:text-sm">
                    { summary }
                </p>
...
const Project = ({ title, type, img, link, github }) => {
    return (
        ...
        border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light  ">
            <div className="absolute top-0 -righst-3 -z-10 w-[101%] h-[103%] rounded-[2rem ]
...
const projects = () => {
    return (
        <>
            <Head>
                <title>CodeBucks | Projects</title>
